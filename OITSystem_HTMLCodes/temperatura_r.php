...
<div class="section">
  ...
  <div class="divizquierda">
    ...
    $stmt = $DBH->prepare('SELECT MIN(temperatura) as min_temp, MAX(temperatura) as max_temp, AVG(temperatura) as avg_temp
FROM dades
WHERE date(fecha) = :fecha');
    ...
    $min = $result['min_temp'];
    $max = $result['max_temp'];
    $avg = round($result['avg_temp']);

    #Mostrem les dades.
    echo "<h1> ESTADISTIQUES TEMPERATURA </h1>";
    echo "<main>";
    echo "<table border='1'>
  <tr>
    <th>Data</th>
    <th>Temperatura avg</th>
  ...
  <tr>
    ...
    <div class="button-container">
      ...
      <form action="humitat_r.php" method="post">
          <input type="hidden" name="Data" value="<?php echo $fecha; ?>">
          <button type="submit" name="humidity" class="button3">Veure la humitat</button>
      </form>
  </div>
  <br>
  <br>
