...
<div class="section">
  ...
  <div class="divizquierda">
    ...
    <section>
      <h1>De quina data vols saber la temperatura?<br/></h1>
      <form method="post" action="temperatura_r.php">
          <p>
  ...
  $stmt = $DBH->prepare('SELECT MIN(temperatura) as min_temp, MAX(temperatura) as max_temp
  ...
  echo "<h1> TEMPERATURA MAXIMA I MINIMA DEL ANY ACTUAL</h1>";
  echo "<table border='1'>
        <tr>
